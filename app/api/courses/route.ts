...
// Base route handler for /api/courses (no path segments)
// This handles requests to /api/courses and forwards them to the course service
...
export async function PUT(req: NextRequest) {
  return handleBaseRequest(req, "PUT");
}

export async function DELETE(req: NextRequest) {
  return handleBaseRequest(req, "DELETE");
}
...
async function handleBaseRequest(req: NextRequest, method: string) {
  try {
    ...
    // Course service expects /course/api/courses/
    ...
    const targetUrl = `${finalBaseUrl}/course/api/courses/${queryString}`;
